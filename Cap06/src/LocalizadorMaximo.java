...
//Metodo LocalizadorMaximo declardo pelo programador com tres parametros double
...
public class LocalizadorMaximo
{
    ...
    public void determinaMaximo()
    {
        ...
        double result = maximo(numero1, numero2, numero3);

        //exibe o valor maximo
        System.out.println("Maximo é: " +result);
    } //fim do metodo determinaMaximo

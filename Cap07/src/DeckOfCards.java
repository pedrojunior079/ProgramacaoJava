//Figura 7.10: BaralhoDeCartas.java --> traduçãoo do ingles DeckOfCards.java
//Classe BaralhoDeCartas representa um baralho.
...
public class DeckOfCards
{
    ...
    public void shuffle()
    {
        ...
        {
            //seleciona um numero aleatÃ³rio entre 0 e 51
            int segundo = randomNumbers.nextInt(NUMBER_OF_CARDS);

            //compara CartaBaraÃ§ho atual com CartaBaralho aleatoriamente selecionado
